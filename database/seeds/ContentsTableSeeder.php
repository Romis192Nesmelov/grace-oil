    ...
    public function run()
    {
        $data = [
            ...
            [
                ...
                'text_ru' => '<p>Компания ООО «Грейс Лубрикантс» выпускает широкий ассортимент смазочных материалов, более 100 наименований технических масел и охлаждающих жидкостей. На выбор потребителей смазочные материалы выпускаются в различных видах фасовки: канистры 1 л., 4 л., 5 л., 20 л., металлические бочки 180 кг., пластиковые кубы 1000 л.</p><p>Продукция GRACE отличается:</p><ul><li>Высокой эффективностью;</li><li>Соответствием требованиям самых жестких отраслевых стандартов, или превосходит их;</li><li>Конкурентоспособной ценой.</li></ul><p>Более 500 товарных позиций позволяют ООО «Грейс Лубрикантс» максимально удовлетворять потребности клиентов в высококачественных смазочных материалах.</p><p>Продукция GRACE производится на основе запатентованной уникальной технологии «Комплекс кавитационно-вакуумного смешения вязких жидкостей», проходит испытания в сложных и экстремальных условиях эксплуатации и застрахована в крупнейшей страховой компании «Ренессанс Страхование».</p>',
                'text_en' => '<p>Grace Lubricants LLC produces a wide range of lubricants, more than 100 types of technical oils and coolants. At the choice of consumers, lubricants are produced in various types of packaging: canisters 1 l., 4 l., 5 l., 20 l., metal barrels 180 kg., plastic cubes 1000 l.</p><p>GRACE products are distinguished by:</p><ul><li>High efficiency;</li><li>Meet or exceed the most stringent industry standards;</li><li>Competitive price.</li></ul><p>More than 500 commodity items allow Grace Lubricants LLC to meet the needs of customers in high-quality lubricants to the maximum.</p><p>GRACE products are manufactured on the basis of the patented unique technology «Complex of cavitation-vacuum mixing of viscous liquids», are tested in difficult and extreme operating conditions and are insured by the largest insurance company «Renaissance Insurance».</p>',
                'sub_menu_id' => 4
            ],
            [
                'preview' => 'images/grace_products.jpg',
                'text_ru' => '<p>Миссией ООО «Грейс Лубрикантс» является всестороннее удовлетворение потребностей клиентов в смазочных материалах, доступных по цене и соответствующих международным стандартам качества и экологической безопасности. Все смазочные материалы Grace производятся с использованием запатентованной уникальной технологией «Комплекс кавитационно-вакуумного смешения вязких жидкостей» из лучших базовых масел и самых современных пакетов присадок мировых производителей. Уникальные технологии производства позволяют превосходить требования ведущих производителей автомобилей, техники и оборудования, а также соответствовать ожиданиям самых требовательных покупателей.</p><p>Компания ООО «Грейс Лубрикантс» строит отношения с поставщиками и клиентами на принципах честной и открытой совместной работы по продвижению продукции GRACE, дорожит своим именем и уважает своих партнеров. Только взаимопонимание и взаимовыгодное сотрудничество может привести к желаемым результатам.</p><p>Стремясь к совершенству, опережаем лидеров!</p>',
                'text_en' => '<p>The mission of Grace Lubricants LLC is to fully meet the needs of customers in lubricants that are affordable and meet international quality and environmental standards. All Grace lubricants are produced using the patented unique technology «Complex of cavitation-vacuum mixing of viscous liquids» from the best base oils and the most modern additive packages from world manufacturers. Unique production technologies allow us to exceed the requirements of leading manufacturers of vehicles, machinery and equipment, as well as meet the expectations of the most demanding customers.</p><p>Grace Lubricants LLC builds relationships with suppliers and customers on the principles of honest and open collaboration to promote GRACE products, values its name and respects its partners. Only mutual understanding and mutually beneficial cooperation can lead to the desired results.</p><p>Striving for excellence, we are ahead of the leaders!</p>',
                'sub_menu_id' => 5
            ],
            [
            ...
            [
                ...
                'head_ru' => 'Технология',
                'head_en' => 'Technology',
                'text_ru' => '<p>Смазочные материалы производятся на сертифицированной установке по модификации технических масел в соответствии с запатентованной уникальной технологией «Комплекс кавитационно-вакуумного смешения вязких жидкостей».</p><p>Данная технология – результат многолетней работы технологов компании ООО «Грейс Лубрикантс».</p><p>Преимущества технологии:</p><p>Данный метод можно назвать «биполярной» технологией, т.е. «двойной» технологией, в результате которой происходит не только смешение ингредиентов (базовых масел и присадок на молекулярном уровне, что улучшает однородность смеси), но и на выходе из установки продукция получается положительный заряд, и тем самым улучшается адгезия: масло притягивается к трущимся поверхностям, создавая более прочную масляную пленку.</p><p>Высокая адгезия и прочная масляная пленка обеспечивают уникальную защиту от износа и увеличенный срок эксплуатации масел.</p><p>Для достижения таких характеристик смазочных материалов многие ведущие лидеры этой отрасли используют дополнительные присадки. Благодаря запатентованной технологии, смазочные материалы GRACE значительно превышают требования стандартов и допусков мировых производителей техники и оборудования, сохраняя при этом самые конкурентные цены.</p>',
                'text_en' => '<p>Lubricants are produced at a certified plant for the modification of technical oils in accordance with the patented unique technology «Complex of cavitation-vacuum mixing of viscous liquids».</p><p>This technology is the result of many years of work of technologists of Grace Lubricants LLC.</p><p>Technology advantages:</p><p>This method can be called «bipolar» technology, i.e. «double» technology, as a result of which not only the ingredients are mixed (base oils and additives at the molecular level, which improves the homogeneity of the mixture), but also at the outlet of the unit, the products receive a positive charge, and thus adhesion improves: the oil is attracted to rubbing surfaces creating a stronger oil film.</p><p>High adhesion and strong oil film provide unique wear protection and extended oil life.</p><p>To achieve these lubricant characteristics, many of the industry\'s leading leaders use additional additives. Thanks to the patented technology, GRACE lubricants significantly exceed the requirements of the standards and tolerances of world manufacturers of machinery and equipment, while maintaining the most competitive prices.</p>',
                'sub_menu_id' => 7
            ],
            [
