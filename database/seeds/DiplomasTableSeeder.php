...
class DiplomasTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ['preview' => 'images/diplomas/mb-approval_228_5_pewview.jpg', 'full' => 'images/diplomas/mb-approval_228_5.pdf', 'text_ru' => 'Сертифика Mercedes Benz для рабочих жидкостей 228.5', 'text_en' => 'Mercedes Benz Specifications for Operating Fluids 228.5'],
            ['preview' => 'images/diplomas/mb-approval_228_51_pewview.jpg', 'full' => 'images/diplomas/mb-approval_228_51.pdf', 'text_ru' => 'Сертифика Mercedes Benz для рабочих жидкостей 228.51', 'text_en' => 'Mercedes Benz Specifications for Operating Fluids 228.51'],
        ];
