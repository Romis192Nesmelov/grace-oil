...
@section('content')
    @include('emails.blocks._head_block',['hLevel' => 1, 'head' => trans('content.test_application')])
    @include('emails.blocks._head_block',['hLevel' => 3, 'head' => trans('content.feedback_email',['email' => $email])])
    @include('emails.blocks._head_block',['hLevel' => 3, 'head' => trans('content.feedback_phone',['phone' => $phone])])
